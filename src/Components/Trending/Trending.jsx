                    ...
                    <div className={`d-none ${style.showInMopile}`}>
                      <div className="container mt-3">
                        <div className="row g-0">
                          <div className="col-7">
                            <div className="text">
                              <h5 className={`colorBlue ${style.cardFontSize}`}> AEON - 2 Bedrooms Typical Apartment </h5>
                            </div>
                          </div>
                          <div className="col-5">
                            <div className="text-end  ">
                            <span className={`text-muted opacity-75  ${style.cardFontSize}`}>
                          ,Aeon Towers
                        </span>
                            </div>
                          </div>
              ...
              <div className="w-50 py-3 m-auto">
                <div className="card">
                  ...
                  <div className="card-body">
                    <h5 className="card-title colorBlue container">
                      Aeon - 3 Bedrooms Apartment
                      <span className="text-muted opacity-75">
                        ,Aeon Towers
                      </span>
